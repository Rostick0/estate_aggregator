    ...
    public function definition(): array
    {
        ...
        if ($random_filter == 1) {
            ...
            return [
                ...
                'property_id' => $type_ids[random_int(1, count($type_ids) - 1)],
            ];
        } else if ($random_filter == 2) {
            $type_ids = [171, 95, 142, 172, 173, 175, 177, 211, 160, 140, 139, 78, 79, 80, 81, 82, 83];

            return [
                'value' => 'Да',
                'property_value_id' => $type_ids[random_int(1, count($type_ids) - 1)],
            ];
        } else if ($random_filter == 3) {
